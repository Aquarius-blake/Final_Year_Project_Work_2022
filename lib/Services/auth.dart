...
//Convert to Custom User
  ...
  Future Signguest() async{
    ...
    try{
      ...
      User1 user1= User1(DOB: "The Beginning",Bio: "Ghost of Sushima",Guest: true,UID: user?.uid,Username:"Guest",Name:"Guest",Gender:"Unknown",Email: "Guest@Guest.com",ppurl:"",searchkey: "Guest".substring(0,1));
